      ...
      <div className="w-full max-w-md border border-line bg-paper p-8 md:p-10">
        ...
        {checkingLink ? (
          ...
          <>
            ...
            <Link
              href="/login"
              className="focus-ring mt-6 block w-full bg-blue px-5 py-3.5 text-center font-body text-sm font-medium text-white transition-colors hover:bg-blue-dark"
            >
              Log in
            </Link>
          </>
          ...
          <>
            <p className="mt-4 font-body text-sm text-red-700">
              {error || "This reset link is invalid or has expired."}
            </p>
            <Link
              href="/forgot-password"
              className="mt-4 inline-block font-body text-sm text-blue hover:text-blue-dark"
            >
              Request a new link
            </Link>
          </>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div>
              <label htmlFor="confirmPassword" className="font-body text-sm font-medium text-navy">
