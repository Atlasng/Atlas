...
const stats = [
  { label: "WhatsApp chats", value: "0" },
  { label: "Dropship inquiries", value: "0" },
    ...
    <main className="min-h-screen bg-paper">
      ...
      <div className="mx-auto max-w-content px-6 py-12 md:px-10">
        ...
        <p className="mt-16 max-w-md font-body text-sm text-navy-soft">
          Sales and traffic analytics will appear here once buyers start
          reaching out to you on WhatsApp.
        </p>
      </div>
    </main>
  );
