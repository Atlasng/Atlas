...
export async function middleware(request: NextRequest) {
  ...
  // NOTE: the delivery-pricing gate that used to live here is gone —
  // delivery is now coordinated directly between buyer and seller over
  // WhatsApp, so a shop no longer needs any pricing setup to list products.
  if (user && request.nextUrl.pathname.startsWith("/dashboard/shop")) {
